...
<body>
    ...
    <div class="mx-auto">
        <span>
            <center><button class="btn btn-success" onclick="generatePdf()">Download PDF</button>&nbsp; <button class="btn btn-primary"><a href="../user/userpermit.php" class="text-decoration-none text-light">Go Back</a></button></center>
        </span>
    </div>
    <br><br>

...
<body>
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="userpermit.php">
                    <i class='bx bx-detail'></i>
                    <span class="link_name">Fishing Permit</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="userpermit.php">Fishing Permit</a></li>
                </ul>
            </li>
            <li>
                <a href="adminbms.php">
            ...
            <li>
                <?php
                $data = $conn->prepare("SELECT count(notif_id) as id FROM `notif` where author > 1");
                $data->execute();
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="adminpa.php">Apply Permit</a></li>

    ...
    if ($select->rowCount() > 0) {
        ...
        if ($password != $cpassword) {
            ...
            if ($insert) {
                ...
                echo "<script>alert('$messagereg'); window.location.href='../admin/adminum.php';</script>";
            }
        }
    }
}
...
<head>
    ...
    <title>NLNP-PAMO | Add New User</title>
...
<body>
    <div class="btn">
        <a href="../admin/adminum.php"><button type="button" class="btn btn-success">Go back</button></a>
    </div>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-12 mx-auto form-group heading">
                <span>
                    <center>
                        <h3 class="text-light"><b>Add New User Account</b></h3>
                    </center>
                </span>
            </div>
        </div>

        ...
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title text-light mx-auto" id="myModalLabel"><span>
                        <center><b>Accept Payment</b></center>
                    </span></h4>
            </div>
            <form method="POST" action="../modal/view-viol-func.php?v_id=<?php echo $row['v_id']; ?>">
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row form-group">
                            <div class="col-6">
                                <span>Full Name:</span>
                                <input type="text" class="form-control" value="<?php echo $row['fname'] . ' ' . $row['lname']; ?>" disabled readonly>
                            </div>
                            <div class="col-6">
                                <span>Municipality:</span>
                                <input type="text" class="form-control" value="<?php echo $row['municipality']; ?>" disabled readonly>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-12">
                        ...
                        <div class="row form-group">
                            <div class="col-8">
                                <span>Penalty:</span>
                                <textarea class="form-control" disabled readonly cols="30" rows="1"><?php echo $row['penalty']; ?></textarea>
                            </div>
                            <div class="col-4">
                                <?php
                                ...
                                <input type="text" class="form-control" value="<?php echo $date; ?>" disabled readonly>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo $date2; ?>" disabled readonly>
                            </div>
                        </div>
                        <hr>

    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg bg-light rounded my-2 py-2">
                ...
                <span>
                    <a href="../modal/add-species.php"><button type="button" class="btn btn-success">Add New Species</button></a>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span><a href="#bmsedit_<?php echo $row['sp_id']; ?>" class="text-decoration-none text-danger" data-bs-toggle="modal">
                                                    <center><b>Edit</b></span></center>
                                            </a></span>
                                            <span><a href="#viewspecies_<?php echo $row['sp_id']; ?>" class="text-decoration-none" data-bs-toggle="modal">
                                                    <center><span><b>View</b></span></center>
                                                </a></span>

                                        </td>
                                        <?php include '../modal/edit-species.php'; ?>
                                        <?php include '../modal/view-species.php'; ?>
                                    </tr>
                            <?php
                                }
